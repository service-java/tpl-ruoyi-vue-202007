...
public class SysJobController extends BaseController {
    ...
    @Log(title = "定时任务", businessType = BusinessTypeEnums.EXPORT)
    @GetMapping("/export")
    ...
    @Log(title = "定时任务", businessType = BusinessTypeEnums.INSERT)
    @PostMapping
    ...
    @Log(title = "定时任务", businessType = BusinessTypeEnums.UPDATE)
    @PutMapping
    ...
    @Log(title = "定时任务", businessType = BusinessTypeEnums.DELETE)
